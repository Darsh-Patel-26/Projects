...
class Frame3 extends JFrame implements ActionListener {
    ...
    ImageIcon i = new ImageIcon("E:\\Submit\\Project\\src\\a\\login2.jpg");
    ...
    Frame3() {
        ...
        l10 = new JLabel("New Student Admission Form");
        l1 = new JLabel("Name");
        ...
        f5.setBounds(250, 450, 200, 30);
        f6.setBounds(250, 520, 200, 30);
        pass.setBounds(750, 130, 200, 30);
        ...
        String[] s = {"B.Tech", "M.Tech", "BBA", "MBA", "BA", "MA", "B.Com", "M.Com", "MBBS", "BHMS", "Other"};
        String[] cast = {"SEBC", "SC", "ST", "General"};
        c1 = new JComboBox(s);
        c1.setBounds(750, 450, 100, 30);
        c2 = new JComboBox(cast);
        c2.setBounds(750, 520, 100, 30);
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == b) {
            ...
            try {
                ...
                s3 = f3.getText();//Phone
                s4 = f4.getText();//Email
                s5 = f5.getText();//College Name
                f = Float.parseFloat(f6.getText());//PR
                s6 = area.getText();//Add
                s7 = (String) c1.getSelectedItem();//Course
                ...
                if (co > 0) {
                    if (f1.getText().equals("") || s2.equals("") || s3.equals("") || s4.equals("") || s5.equals("") || s6.equals("") || s7.equals("") || s8.equals("") || s9.equals("") || s10.equals("") || s11.equals("") || f6.getText().equals("")) {
                        JOptionPane.showMessageDialog(this, "Some Fields Are Empty", "Yepee", JOptionPane.WARNING_MESSAGE);
                    } else {
